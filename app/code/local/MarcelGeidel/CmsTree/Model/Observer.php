...
class MarcelGeidel_CmsTree_Model_Observer
{
    ...
    private function addMenuNodes($nodes, $menu)
    {
    ...
    public function updateBreadcrumbs(Varien_Event_Observer $observer)
    {

        /** @var MarcelGeidel_CmsTree_Block_Breadcrumbs $breadcrumbs */
        if ($breadcrumbs = Mage::getSingleton('core/layout')->getBlock('breadcrumbs')) {
            ...
            $pageID  = Mage::getModel('cms/page')->checkIdentifier(Mage::getSingleton('cms/page')
                                                                       ->getIdentifier(), $storeID);
    ...
    public function updateCmsTree(Varien_Event_Observer $observer)
    {
    ...
    public function addCmsPageField(Varien_Event_Observer $observer)
    {
